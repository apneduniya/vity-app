...
export const metadata = constructMetaData({
  title: "404 | Vity",
  description: "This is the 404 Page for Vity",
});

const NotFound = () => {
  return (
    <div className="relative flex h-screen w-full overflow-hidden rounded-md bg-white antialiased dark:bg-background md:items-center md:justify-center">
